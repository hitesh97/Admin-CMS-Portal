	        ...
	        <div className="custom-margin">
	            ...
	            <div>
	                <p>It is my pleasure to introduce
	                    <a href={`mailto:${this.props.data.email}`}> {this.props.data.first_name} </a>. {this.props.data.genderOps1} has joined the {this.props.data.team} team at {this.props.data.location} as an {this.props.data.designation} and will work with {this.props.data.supervisor}.</p>
	            </div>
	            <div>                
